...
def play_game():
    ...
    while True:
        ...
        if start:
            game_mode = int(input("Please enter either 1 to play against another person " 
            ...
            if game_mode == 1:
                ...
                while True:
                    ...
                    if current_player == player1:
                        ...
                        computer_choice(current_player)
        ...
        rematch = int(input('Do you want to set up a new game in main menu?'
                            ' (1 to go to menu and 2 to quit) '))
